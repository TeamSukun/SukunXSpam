...
from SUKUNXSPAM.utils import load_plugins
import logging
...
sukun = "🎉 Successfully Deployed SukunXSpamBot 🎉 @TeamSukun Enjoy! Do visit baby @sukunsupports"
print(sukun[0: ])
